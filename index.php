...
$user_name="root";
$password="";
$name_data_base = "trit_finalpro_db";
$conn = mysqli_connect($server_name,$user_name,$password,$name_data_base);
if(isset($_POST['submit']))
  {
    ...
    $sql = "SELECT * FROM `tblappointment` WHERE AptDate = \"$adate\" and AptTime = \"$atime\";";
    $Answer = mysqli_query($conn, $sql);
    $row = mysqli_fetch_array($Answer);
 if($row)
 {
    echo '<script type="text/javascript">';
		echo ' alert("The booking date is taken by someone else Sorry, you can choose another time...")'; 
		echo '</script>';
 }
 else  
 {
    ...
    $to = "$email";
	$subject = "MASSAGE FROM TRIT";
	$txt = "
			Hi $name
			Your Appointment No': $aptnumber
			For $services Tritment
			Your $adate
			in $atime

			Our professional team is waiting for your arrival
			TIRT BEST FOR Business";
				
	$headers = "From: datatrit@gmail.com" . "\r\n" .
	"CC: datatrit@gmail.com";
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/2.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Beauty Design</span>
			            <h1 class="mb-4">Get Pretty Nails</h1>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <h1 class="mb-4">Menicure Pedicure</h1>
    			...
    			<div class="one-forth d-flex align-items-end">
    				<div class="text">
			            ...
			            <div class="row">
			              ...
			              <div class="col-sm-12">
			                <div class="form-group">
			                  <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" required="true" maxlength="10" minlength="10">
			                </div>
			              </div>
				          </div>
				          <div class="form-group">
...
?>
              <p><?php  echo substr($row['PageDescription'],0,200);?> <a href="sales.php"></a></p><?php } ?> </p></center>
   				</div>
