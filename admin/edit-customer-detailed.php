...
<html>
<head>
<title>Trit || Edit Customer</title>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Gender:</label><br> <?php if($row['Gender']=="Male")
{?><input type="radio" id="gender" name="gender" value="Male" checked="true">Male

                     <input type="radio" name="gender" value="Female">Female
                     <input type="radio" name="gender" value="Else">Else
                   <?php } ?>
...
{?><input type="radio" id="gender" name="gender" value="Male" >Male
 ...
 <input type="radio" id="gender" name="gender" value="Male" >Male
  <input type="radio" name="gender" value="Female" >Female
  <input type="radio" name="gender" value="Else" checked="true">Else
                   <?php }?>
                   <div class="form-group"><br> <label for="exampleInputEmail1">Details</label> <textarea type="text" class="form-control" id="details" name="details" placeholder="Details" required="true" rows="12" cols="4"><?php  echo $row['Details'];?></textarea> </div>
